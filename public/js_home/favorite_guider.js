...
document.addEventListener('DOMContentLoaded', function () {
    ...
    bookNowBtns.forEach(bookNowBtn => {
        ...
        bookNowBtn.addEventListener('click', (event) => {
            ...
            const guiderId = bookNowBtn.dataset.guiderId;
            $.ajax({
                type: "GET",
                url: "/check_login_cus",
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.success) {
                                    Swal.fire({
                                        title: 'Thông báo',
                                        text: 'Guider đã thêm vào danh sách yêu thích!',
                                        icon: 'success',
                                        time: 4000
                                    });
                                    ...
                                    Swal.fire({
                                        title: 'Thông báo',
                                        text: 'Guider đã bị xóa khỏi danh sách yêu thích!',
                                        icon: 'success',
                                        time: 4000
                                    });
