                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    <div class="row mrg-0">
                        <div class="tr-single-box short-box">
                            <div class="col-sm-8 hidden-xs align-self-center">
                                <h4>Từ khóa: {{ $search }}</h4>
                            </div>
                                            ...
                                            <div class="col-md-5 col-sm-5">
                                                <div class="hotel-box-image">
                                                    ...
                                                    <div class="entry-bookmark">
                                                        <a href="{{ route('blogSingle', ['id' => $item->id]) }}"><i
                                                                class="ti-bookmark"></i></a>
                                                    </div>
                                                    ...
                                                    <div class="box-inner-ellipsis">
                                                        <div style="margin: 0px; padding: 0px; border: 0px;">
                                                            {{-- @if (!empty($categoryblog))
                                                                @foreach ($categoryblog as $key1 => $item1)
                                                                    @if ($item1->id == $item->category_id) --}}
                                                            <h3 class="entry-title">
                                                                <a href="">{{ $item->cate_blog->dm_blog_name }}</a>
                                                            </h3>
                                                            {{-- @endif
                                                                @endforeach
                                                            @endif --}}
                                                            <div class="entry-content">
                                                                <p>{{ $item->title }}</p>
                                                                {{-- <span class="price">by <strong
                                                                        class="theme-cl">Admin</strong>
                                                                </span> --}}
