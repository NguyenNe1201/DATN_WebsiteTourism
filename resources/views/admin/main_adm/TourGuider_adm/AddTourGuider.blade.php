        ...
        <div class="row mrg-0 mrg-top-20">
            <div class="tr-single-box">
                <div class="tr-single-header">
                    <h3 class="dashboard-title">Add Tour Guider</h3>
                </div>
                {{-- @include('admin.alert')
                @if (session('error'))
                ...
                <div class="tr-single-body">
                    <form id="add_guider" class="jquery_valiss" action="{{ route('post_tour_guider') }}" method="POST"
                            ...
                            <div style="display: flex; flex-wrap: wrap;">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" name="name_guider" class="form-control" placeholder="Nguyễn Văn A"
                                      value="{{ old('name_guider') }}"   required>
                                </div>
                                <div class="col-xs-6">
                                    <label for="email_guider">Email</label>
                                    <input type="email" name="email_guider" class="form-control"
                                        placeholder="quanghthin123@gmail.com" value="{{ old('email_guider') }}" required>
                                    @error('email_guider')
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <select name="sex_guider" class="form-control wide" required>
                                        <option value="" class="option selected focus">Chọn giới tính</option>
                                        <option value="0" class="option">Nam</option>
                                        <option value="1" class="option">Nữ</option>
                                    </select>
                                </div>
                                <div class="col-xs-6">
                                    <label for="price_1date">Giá/1 Ngày</label>
                                    <input type="text" name="price_1date" class="form-control"
                                        placeholder="200000vnd/ngày" value="{{ old('price_1date') }}" />
                                </div>
                                <div class="col-xs-6">
                                    <label for="phone_guider">Số điện thoại</label>
                                    <input type="text" name="phone_guider" class="form-control"
                                        placeholder="+0123 456 789" value="{{ old('phone_guider') }}"  />
                                </div>
                                <div class="col-xs-6">
                                    <label for="language_guider">Ngôn Ngữ</label>
                                    <input type="text" name="language_guider" class="form-control"
                                        placeholder="English, French,..." value="{{ old('language_guider') }}"  />
                                </div>
                                <div class="col-xs-6">
                                    <label for="address_guider">Address</label>
                                    <input type="text" class="form-control" name="address_guider" value="{{ old('address_guider') }}" 
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <select name="role" class="form-control wide" required>
                                        ...
                                        <option value="0">Theo tour</option>
                                        <option value="1">Tự do</option>
                                    </select>
                                </div>
                                <div class="col-xs-6">
                                    <label for="birthday_guider">Ngày Sinh</label>
                                    <input type="date" name="birthday_guider" class="form-control" value="{{ old('birthday_guider') }}" 
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <textarea value="{{ old('describe_guider') }}"  name="describe_guider" class="form-control height-120" placeholder="mô tả về hướng dẫn viên..."></textarea>
                                </div>
