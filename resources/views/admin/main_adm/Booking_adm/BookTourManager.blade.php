        ...
        <div class="row mrg-0 mrg-top-20">
            <div class="tr-single-box">
                <div class="tr-single-header">
                    <h3 class="dashboard-title">Danh Sách Đặt Tour</h3>
                </div>
                <div class="tr-single-body">
                    <div class="table-responsive" style="margin-top: 20px; ">
                        <table class="table table-striped table-hover" id="table_list_book_tour" data-page-length='5'>
                            ...
                            <tbody>
                                <!-- tr -->
                                @if (!empty($getsigntour))
                                    @foreach ($getsigntour as $key => $item)
                                        <tr>
                                            <td>
                                                {{ $key + 1 }}
                                                {{-- {{ $item->id }} --}}
                                            ...
                                            <td>
                                                <b>Tour: </b>{{ $item->tour->tourname }} <br>
                                                <b>Thời gian: </b>{{ $item->tour->tour_date }} ngày <br>
                                                <b>Địa điểm: </b>{{ $item->tour_location->location_name }} <br>
                                            ...
                                            <td>
                                                ...
                                                <b>Số người tham gia: </b> {{ $item->Regis_number }} <br>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a href="{{ route('Get_id_guider', ['sign_tour_id' => $item->id]) }}"
                                                            class="dropdown-item fw-500"><i
                                                                class="ti-pencil-alt m-r-5"></i> Edit Guider</a>
                                                        @endif
